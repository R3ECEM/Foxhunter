This Script locates and uninstalls all versions of Mozilla Firefox from the device. Allowing you to remove all unpatched versions across a large set of devices all at once.
